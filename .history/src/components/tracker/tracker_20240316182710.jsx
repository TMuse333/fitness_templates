...
import { DateRangePicker } from '@datepicker-react/styled';
...
setInsertData(true)
  ...
  return (
    ...
    <DateRangePicker
        ...
        endDate={selectedDate} // Using the same selected date for endDate
        focusedInput="startDate" // Always focusing on the startDate
        onDatesChange={handleDateChange}
        showDateDisplay={false} // Hides the date display at the top
        calendarPosition="bottom" // Ensure calendar appears below the input
      />
  </form>
