    ...
    <div className="tracker-container">
      ...
      {weeklyProgressSelected && (
        <div className="weekly-progress-container">
          ...
          {/* "Previous" button */}
          <button onClick={prevExercise} disabled={progressDataLength <= 1 || selectedExerciseIndex === 0}>
            Previous
          </button>

          {/* "Next" button */}
          <button onClick={nextExercise} disabled={progressDataLength <= 1 || selectedExerciseIndex === progressDataLength - 1}>
            Next
          </button>
        </div>
      )}
