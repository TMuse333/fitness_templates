...
>
  {description ||"Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illo laboriosam corrupti perspiciatis consectetur reprehenderit facere. Magnam nam accusamus eligendi dignissimos."}
       ...
       <Link to={link}>
           <button className="button">{linkText}</button>
                ...
                <div className="image-box">
                    <h1 className="title-text">{title || "Your title here"}</h1>
                    <motion.img
                        id={imageId}
                        src={image}
                        loading="lazy"
