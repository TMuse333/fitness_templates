        ...
        {products.map((product, index) => (
          <div
            ...
            style={{
                ...
                transition:
                 positions[(currentPosition + index) % positions.length].left !== '0%' && positions[(currentPosition + index) % positions.length].left !== `${(positions.length - 1) * 50}%` ? 'left 0.5s ease, transform 0.5s ease' : 'none',
