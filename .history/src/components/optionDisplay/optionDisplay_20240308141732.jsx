...
const ProductCarousel = () => {
  ...
  const combinedVariants = {
    ...
    visible: {
      ...
      height: '60vw',
      transition: {
        duration: 0.4, // Set the duration to 0.4 seconds for common transitions
        ...
        {products.map((product, index) => (
          ...
          >
            <div className="image-button-container">
              ...
              <motion.img 
              initial={imageStyle.initial}
              animate={inView ? imageStyle.animate : imageStyle.initial}
                src={product.image}
                alt={`Product ${index + 1}`}
                key={index}
              />
