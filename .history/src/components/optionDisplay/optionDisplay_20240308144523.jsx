...
const ProductCarousel = () => {
  ...
  const [ref, inView] = useInView({
    triggerOnce: false,
    threshold: [0.4, 0.8], // Adjust the threshold as needed
  });
  ...
  const combinedVariants = (index) =>  {
    ...
    hidden: {
      ...
      transition: {
        ...
        height: { duration: 0.1, ease: 'easeInOut' }, // Add transition for the height property
      },
    },
    visible: {
      opacity: 1,
      ...
      transition: {
        ...
        duration: 0.3, // Set the duration to 0.4 seconds for common transitions
