...
const ProductCarousel = () => {
  ...
  useEffect(() => {
    // Update the center index whenever the carousel moves
    const middleIndex = Math.floor(products.length / 2);
    setCenterIndex((currentPosition + middleIndex) % positions.length);
    console.log("Centered Image Src:", products[centerIndex].image);
  }, [currentPosition, positions.length, products.length]);
