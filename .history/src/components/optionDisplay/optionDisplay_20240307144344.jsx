...
const ProductCarousel = () => {
  ...
  const positions = Array.from({ length: products.length }, (_, index) => ({
    const angle = (index / products.length) * 360; // Calculate angle based on the number of elements
    const radius = 100; // You can adjust the radius
    const centerX = 50; // Adjust as needed
    const centerY = 50; // Adjust as needed
