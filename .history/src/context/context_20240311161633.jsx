...
export const WorkoutProvider = ({ children }) => {
    ...
    const calculateProgress = () => {
        ...
        //         const weightDiff = exercise.workouts[i+1].sets.weight - exercise.workouts[i].weight


        //       console.log(`Workout diff`,weightDiff);

        //     }
        //   });


          console.log('first progress',progressData[0].workouts[0].sets[0].wei)
