        ...
        if (weekSelected) {
          ...
          progressData.forEach((exercise) => {
            ...
            for (let i = 0; i < exercise.workouts.length ; i++) {
                ...
                for(let j = 0; j < exercise.workouts[i].sets.length -1; j++){
                    ...
                    console.log(`weight difference  on ${exercise.name}between
                     ${exercise.workouts[j+1].date} and
                     ${exercise.workouts[j].date} is
                     `,weightDiff)
            ...
            const lastWeight = lastWorkout && lastWorkout.sets && lastWorkout.sets[j] && lastWorkout.sets[j].weight;

            console.log('the last weight is',)
