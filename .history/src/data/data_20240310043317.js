  ...
  export const designAdvantages2 = [
   ...
   export const hydrolistIntro1 = {
    ...
    export const testimonials = [
        ...
        {
            quote: 'A real one',
            effect: "Collaborating with Aboubacar was an extraordinary experience, showcasing his prowess as a resilient and skilled warrior. His commitment to detail and original strategies sets him apart, making him an unparalleled choice in the field. If you're contemplating working with Aboubacar, consider this your cue to seize the opportunity and empower yourself or your enterprise!",
            author: '- Escalade',
            title: 'Warrior'
        },
    ...
    export const portfolio = [
        {
          name:'Mediatation',
          description:'Meditation is very important as you can desing the life you want from within and then work very hard everyday to acheive it in reality',
          // link:'https://saineymedia.com'
        },
        {
          name:'Striker',
          description:'Be ready for whatever through hard training everyday '+
          'The aura looks pretty nice on this one'
